import {LOAD_VIDEO, PLAYER_READY, VIDEO_DONE} from '../constants/actionTypes';
...
export default function YTStreamReducer(state = initialState.YTStream, action) {
  let newState;

  switch (action.type) {
    // case SAVE_FUEL_SAVINGS:
    //   // For this example, just simulating a save by changing date modified.
    //   // In a real app using Redux, you might use redux-thunk and handle the async call in YTStreamActions.js
